...
func (attr *Attribs) GetServerStatusDataPoints(i int) ServerStatusDoc {
	...
	ss.Metrics.Document.Returned = int(attr.get("serverStatus/metrics/document/returned", i))
	ss.Metrics.Document.Inserted = int(attr.get("serverStatus/metrics/document/inserted", i))
	ss.Metrics.Document.Updated = int(attr.get("serverStatus/metrics/document/updated", i))
	ss.Metrics.Document.Deleted = int(attr.get("serverStatus/metrics/document/deleted", i))
